...
export const allProjects: ProjectData[] = [
  // Brickwork Projects (4 images)
  {
    ...
    category: 'brickwork',
    location: 'Alberton',
    image: '/images/sinqobile-construction-brickwork-alberton-78.jpg',
    description: 'High-quality brickwork construction with precision laying and mortar finishing.',
    completionYear: 2024,
    duration: '1 week',
    clientType: 'residential',
    featured: false,
    seoAlt: 'Professional brickwork construction by Sinqobile Construction in Alberton',
  ...
  },
  {
    ...
    category: 'brickwork',
    location: 'Bryanston',
    image: '/images/sinqobile-construction-brickwork-bryanston-18.jpg',
    description: 'Elegant decorative brick wall with architectural detailing and premium finish.',
    completionYear: 2024,
    duration: '5 days',
    clientType: 'residential',
    featured: false,
    seoAlt: 'Decorative brick wall installation in Bryanston by Sinqobile Construction',
  ...
  },
  {
    ...
    category: 'brickwork',
    location: 'Lanseria',
    image: '/images/sinqobile-construction-brickwork-lanseria-49.jpg',
  ...
  },
  {
    ...
    category: 'brickwork',
    location: 'Roodepoort',
    image: '/images/sinqobile-construction-brickwork-roodepoort-35.jpg',
    description: 'Load-bearing brick construction with reinforcement and quality mortar joints.',
    completionYear: 2024,
    duration: '2 weeks',
    clientType: 'commercial',
    featured: false,
    seoAlt: 'Structural brick construction in Roodepoort by Sinqobile Construction',
  ...
  },
  {
    ...
    category: 'building',
    location: 'Rosebank',
    image: '/images/sinqobile-construction-building-rosebank-48.jpg',
    ...
    seoAlt: 'Modern kitchen renovation by Sinqobile Construction in Rosebank',
  ...
  },
  {
    ...
    category: 'building',
    location: 'Springs',
    image: '/images/sinqobile-construction-building-springs-54.jpg',
  ...
  // Concrete Work Projects (8 images)
  {
    ...
    image: '/images/sinqobile-construction-concrete-bedfordview-31.jpg',
  ...
  },
  {
    ...
    category: 'concrete',
    location: 'Boksburg',
    image: '/images/sinqobile-construction-concrete-boksburg-90.jpg',
    description: 'Level concrete slab with proper reinforcement and smooth finish.',
    completionYear: 2024,
    duration: '3 days',
    clientType: 'residential',
    featured: false,
    seoAlt: 'Concrete slab installation in Boksburg by Sinqobile Construction',
  ...
  },
  {
    ...
    category: 'concrete',
    location: 'Germiston',
    image: '/images/sinqobile-construction-concrete-germiston-32.jpg',
  ...
  },
  {
    ...
    image: '/images/sinqobile-construction-concrete-johannesburg-86.jpg',
  ...
  },
  {
    ...
    category: 'concrete',
    location: 'Lanseria',
    image: '/images/sinqobile-construction-concrete-lanseria-22.jpg',
  ...
  },
  {
    ...
    category: 'concrete',
    location: 'Midrand',
    image: '/images/sinqobile-construction-concrete-midrand-79.jpg',
  ...
  },
  {
    ...
    category: 'concrete',
    location: 'Sandton',
    image: '/images/sinqobile-construction-concrete-sandton-36.jpg',
    description: 'Professional reinforced concrete foundation work for a new residential development.',
    completionYear: 2024,
    duration: '2 weeks',
    clientType: 'residential',
    featured: true,
    seoAlt: 'Sinqobile Construction concrete foundation work in Sandton, Gauteng',
  ...
  },
  {
    ...
    category: 'concrete',
    location: 'Soweto',
    image: '/images/sinqobile-construction-concrete-soweto-56.jpg',
  ...
  // Paving Projects (8 images)
  {
    ...
    category: 'paving',
    location: 'Centurion',
    image: '/images/sinqobile-construction-paving-centurion-58.jpg',
    ...
    seoAlt: 'Professional driveway paving by Sinqobile Construction in Centurion',
  ...
  },
  {
    ...
    category: 'paving',
    location: 'Lanseria',
    image: '/images/sinqobile-construction-paving-lanseria-91.jpg',
  ...
  },
  {
    ...
    category: 'paving',
    location: 'Riversands',
    image: '/images/sinqobile-construction-paving-riversands-68.jpg',
...
export const getProjectsByLocation = (location: string) => 
  allProjects.filter(project => project.location.toLowerCase().includes(location.toLowerCase()))
...
export const getAllLocations = () =>
  Array.from(new Set(allProjects.map(project => project.location))).sort()

// Note: This file contains the first batch of projects (20 out of 82)
// Additional projects will be added in subsequent updates to complete the full gallery
